...
export const BUILDINGS: Record<string, BuildingDefinition> = {
  ...
  "puck-building": {
    ...
    footprint: { width: 6, height: 6 },
    sprites: {
      south: "/Building/landmark/6x6puck_building_south.png",
      north: "/Building/landmark/6x6puck_building_north.png",
      east: "/Building/landmark/6x6puck_building_east.png",
      west: "/Building/landmark/6x6puck_building_west.png",
    },
    icon: "🏢",
    supportsRotation: true,
  },
